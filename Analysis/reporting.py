...
def generate_forensic_report(output_pdf_path, log_file_name, summary_stats, timeline_data,
    ...
    # --- Section 1: Flight Timeline (The Table) ---
    ...
    if timeline_data:
        # Table Header
        pdf.set_fill_color(50, 50, 100) # Dark Blue Header
        pdf.set_text_color(255, 255, 255) # White Text
        pdf.set_font('Arial', 'B', 10)
        
        # Columns: Time (UTC) | Flight Time | Event Details
        ...
        for row in timeline_data:
            # Zebra Striping: Light gray for alternate rows
            if fill:
    ...
    pdf.add_page() # Force new page for data plots
